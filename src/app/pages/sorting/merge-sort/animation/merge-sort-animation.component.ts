...
@Component({
  selector: 'merge-sort-animation',
  templateUrl: './merge-sort-animation.component.html',
  styleUrl: './merge-sort-animation.component.scss',
})
export class MergeSortAnimationComponent {
